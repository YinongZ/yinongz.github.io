...
document.getElementById('reset-btn').addEventListener('click', () => {
    ...
    // Reset poem display
    document.getElementById('poem-display').textContent = 'Select elements and click generate to create your surrealist composition...';
});
...
function generatePoem() {
    ...
    let transformedAction = randomAction;
    ...
    // Create final poem
    let finalPoem = `${transformedSubject} ${transformedAction} ${transformedObject}${poemExtension}`;
